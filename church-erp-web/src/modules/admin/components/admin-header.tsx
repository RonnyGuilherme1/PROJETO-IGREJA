      ...
      <div className="mx-auto flex min-h-14 w-full max-w-7xl items-center justify-between gap-3 px-4 py-2 sm:px-6 lg:px-8">
        <div className="flex min-w-0 items-center gap-2.5">
          ...
          <BrandLogo
            ...
            icon={Building2}
            className="size-9 shrink-0 rounded-xl border border-border bg-card shadow-xs"
            iconClassName="size-4.5 text-primary"
          />
          <div className="min-w-0 space-y-0.5">
            <p className="truncate text-[10px] font-medium uppercase tracking-[0.18em] text-muted-foreground/80">
        ...
        <div className="flex shrink-0 items-center gap-2">
          <div className="hidden rounded-full border border-border bg-card/80 px-2.5 py-1 text-[11px] text-muted-foreground sm:block">
            {formattedDate}
          </div>
