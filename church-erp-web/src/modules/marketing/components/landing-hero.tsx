...
export function LandingHero({ content }: LandingHeroProps) {
  return (
    <section className="relative isolate overflow-hidden">
      ...
      <div className="grid min-h-[calc(100svh-1rem)] w-full items-center gap-14 px-5 pb-20 pt-32 sm:px-6 sm:pb-24 sm:pt-36 lg:grid-cols-[minmax(0,1.18fr)_minmax(520px,0.82fr)] lg:gap-20 lg:px-10 lg:pb-28 lg:pt-40 xl:px-16 2xl:grid-cols-[minmax(0,1.24fr)_minmax(620px,0.76fr)] 2xl:px-24">
        <div className="relative z-10 max-w-4xl space-y-9">
          ...
          <div className="space-y-6">
            <h1 className="max-w-4xl text-4xl font-semibold tracking-tight text-white sm:text-5xl lg:text-6xl xl:max-w-[16ch] xl:text-[4.6rem] xl:leading-[1.01] 2xl:max-w-[17ch]">
              {content.title}
            </h1>
        ...
        <div className="relative z-10 w-full max-w-[720px] lg:justify-self-end">
          <div className="absolute inset-0 rounded-[44px] bg-[radial-gradient(circle_at_top_right,rgba(216,187,123,0.16),transparent_32%),radial-gradient(circle_at_bottom_left,rgba(31,91,73,0.3),transparent_38%)] blur-2xl" />

          <Card className="relative overflow-hidden rounded-[38px] border-white/10 bg-[linear-gradient(160deg,rgba(8,21,16,0.92)_0%,rgba(14,40,31,0.92)_100%)] p-5 text-white shadow-[0_38px_110px_rgba(3,9,7,0.34)] sm:p-8 xl:p-9">
          ...
          <div className="absolute -left-10 top-16 hidden w-52 rounded-[30px] border border-white/10 bg-[#0d2019]/88 p-4 text-white shadow-[0_24px_56px_rgba(3,9,7,0.22)] backdrop-blur xl:block">
            <div className="flex items-center gap-3">
              <div className="flex size-10 items-center justify-center rounded-2xl border border-[#d8bb7b]/20 bg-[#d8bb7b]/10 text-[#f4dfb2]">
                <Users className="size-4" />
              </div>
              <div>
                <p className="text-sm font-semibold text-white">Gestão de membros</p>
                <p className="text-xs text-white/52">Acompanhamento mais claro</p>
              </div>
            </div>
          </div>

          <div className="absolute -right-8 bottom-12 hidden w-56 rounded-[30px] border border-white/10 bg-[#0d2019]/88 p-4 text-white shadow-[0_24px_56px_rgba(3,9,7,0.22)] backdrop-blur xl:block">
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-white">Controle financeiro</p>
                  <p className="text-xs text-white/52">Mais ordem no dia a dia</p>
                </div>
              </div>
              <div className="rounded-2xl border border-white/8 bg-white/[0.04] p-3">
                <div className="flex items-center gap-2 text-sm text-white/72">
                  <ChartColumn className="size-4 text-[#d8bb7b]" />
                  Operação acompanhada com mais contexto.
                </div>
              </div>
            </div>
          </div>
